...
# Running the classifier on all of the images 
truth_labels = get_pet_labels("pet_images/")
classifier_labels = []
for i in range(len(truth_labels)):
      classified_label = classifier("pet_images/{}".format(list(truth_labels.keys())[i]),model).lower()
